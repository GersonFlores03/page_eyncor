...
import nosotros from "../assets/nosotros/nosotros.webp"
import icon_analisis from "../assets/adaptable/analisis.webp"
import icon_frontera from "../assets/adaptable/frontera.webp"
import icon_innovacion from "../assets/adaptable/innovacion.webp"
import icon_reporte from "../assets/adaptable/reporte.webp"
import icon_servidor from "../assets/adaptable/servidor.webp"
...
import adaptable from "../assets/adaptable/banner_adaptable.webp"
    ...
    return (
        <section className='eyncor_productos  lg:mt-[103px] '>
                ...
                <Carousel.Item>
                    ...
                    lg:absolute lg:top-[60%] lg:left-0 lg:-translate-y-1/2 lg:text-left ñg:pl-[200px]">
                        <div className='flex flex-col gap-4'>
                            <strong className='text-2xl  lg:text-5xl'>Maximizando la Eficiencia con un ERP Adaptable</strong>
            ...
            <div className='eyncor_productos_estaciones mb-3'>
                ...
                lg:text-5xl
                '>
                    Explora los Módulos de Adaptable ERP
                </h2>
                <h4 className='
                eyncor_subtitulo
                text-center
            ...
            <div className='eyncor_productos_estaciones'>
                ...
                lg:text-4xl
                '>
                    Potencia tu negocio con nuestro ERP Adaptable
                </h2>
                <h4 className='
                eyncor_subtitulo
                text-center
            ...
            <div className='grifo_modulo_general mb-11'>
                <div className='modulo_contometro p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    <section className='icono_contometro'>
                        <img src={icon_analisis} className='w-16' alt="icon_grifo" />
                    </section>
                    ...
                    <section className='contometro_texto w-80'>
                        ...
                        <p className='text-white'>
                            Invierta en servicios informáticos modernos con EYNCOR para un control eficiente y niveles altos de rentabilidad en tiempo real.
                        </p>
                    </section>
                </div>
                <div className='modulo_soporte p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    <section className='icono_soporte'>
                        <img src={icon_innovacion} className='w-16' alt="icon_soporte" />
                    </section>
                    ...
                    <section className='soporte_texto w-80'>
                        ...
                        <p className='text-white'>
                            Innovamos para colocar su empresa a la vanguardia con EYNCOR, ofreciendo un sistema excepcional y una gestión única del conocimiento empresarial.
                        </p>
                    </section>
                </div>
                <div className='modulo_tanques p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    <section className='icono_tanques'>
                        <img src={icon_reporte} className='w-16' alt="icon_camionn" />
                    </section>
                    ...
                    <section className='tanques_texto w-80'>
                        ...
                        <p className='text-white'>
                            Maximice rentabilidad con servicios informatizados de EYNCOR, brindando gestión administrativa eficaz, reportes gerenciales accesibles en web o móvil, entre otros.
                        </p>
                    </section>
                </div>
                <div className='modulo_actualizacion p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    <section className='icono_actualizacion'>
                        <img src={icon_frontera} className='w-16' alt="" />
                    </section>

                    <section className='actualizacion_texto w-80'>
                        <h3 className='text-xl text-white font-bold mb-2'>
                            Sin fronteras para su empresa
                        </h3>
                        <p className='text-white'>
                            EYNCOR impulsa el crecimiento de su empresa con soluciones innovadoras, información en tiempo real y asesoramiento contable en ERP, CRM y BI.
                        </p>
                    </section>
                </div>
                <div className='modulo_gestion p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    ...
                    <section className='gestion_texto w-80'>
                        ...
                        <p className='text-white'>
                            Control total de stocks, producción, ventas, créditos, cobranzas, contabilidad y seguimiento de clientes, para lograr expansión y productividad con orden y control organizativo.
                        </p>
                    </section>
                </div>
                <div className='modulo_contabilidad p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    <section className='icono_contabilidad'>
                        <img src={icon_servidor} className='w-16' alt="" />
                    </section>

                    <section className='contabilidad_texto w-80'>
                        <h3 className='text-xl text-white font-bold mb-2'>
                            Servidores de alta tecnología
                        </h3>
                        <p className='text-white'>
                            Proteja su información con servidores dedicados de alto rendimiento y máxima seguridad en EYNCOR, garantizando monitoreo constante.
                        </p>
                    </section>
                </div>
            </div>
