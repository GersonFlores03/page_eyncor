...
import callcenter from "../assets/tienda/callcenter.webp"
    ...
    return (
        <section className='eyncor_productos lg:mt-[103px]'>
                ...
                <Carousel.Item>
                    ...
                    lg:absolute lg:top-[60%] lg:left-0 lg:-translate-y-1/2 lg:text-left ñg:pl-[200px]">
                        <div className='flex flex-col gap-4'>
                            <strong className='text-2xl  lg:text-5xl'>ERP PARA CALL CENTER INTEGRADO</strong>
            ...
            <div className='eyncor_productos_estaciones mb-3'>
                ...
                lg:text-5xl
                '>
                    Explora los módulos de Call Center ERP
                </h2>
                <h4 className='
                eyncor_subtitulo
                text-center
            ...
            <div className='eyncor_productos_estaciones'>
                ...
                mb-10
                '>
                    Descubre nuestro ERP especializado para Call Center, brinda control integral de calidad.
                </h4>
            </div>
