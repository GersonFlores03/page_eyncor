...
import banner_confianza from "../assets/banners/banner_confianza.webp"
import confianza_img1 from "../assets/nosotros/confianza_img1.webp"
import confianza_img2 from "../assets/nosotros/confianza_img2.webp"
                ...
                <Carousel.Item>
                    ...
                    lg:absolute lg:top-[60%] lg:left-0 lg:-translate-y-1/2 lg:text-left ñg:pl-[200px]">
                        <div className='flex flex-col gap-4'>
                            <strong className='text-2xl  lg:text-5xl'>Confía en EYNCOR ERP</strong>
                    ...
                    <div class="grid items-center md:grid-cols-2 md:gap-x-20 gap-y-10">
                        <div class="pl-16 pr-10 sm:pl-6 md:pl-0 xl:pr-0 md:order-2 hidden">
                            <div class="overflow-hidden aspect-w-3 aspect-h-4">
                                <img class="object-cover rounded-lg w-full h-full" src={confianza_img1} alt="" />
                            </div>
                        </div>
                        ...
                        <div class="md:order-1">
                            ...
                            <p class="mt-4 text-xl leading-relaxed text-gray-600">En Eyncor, nuestra misión es Transformar Desafíos en Oportunidades. Nos comprometemos a ofrecer soluciones ERP que inspiren la innovación continua y conviertan los obstáculos empresariales en oportunidades estratégicas de crecimiento. Trabajamos de cerca con nuestros clientes para impulsar la eficiencia, la agilidad y el éxito sostenible en sus empresas.</p>
                        </div>
            ...
            <section class="py-10 sm:py-16 lg:py-24">
                <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
                    <div class="grid items-center md:grid-cols-2 md:gap-x-20 gap-y-10">
                        ...
                        <div class="md:order-1">
                            <h2 class="eyncor_titulo text-3xl font-bold leading-tight sm:text-4xl lg:text-4xl"> Construyendo Caminos hacia el Éxito </h2>
                            <p class="mt-4 text-xl leading-relaxed text-gray-600">Únete a nuestro equipo dinámico, donde colaboramos de manera sinérgica para superar desafíos y alcanzar metas ambiciosas. Si eres apasionado por contribuir al crecimiento colectivo y valoras un ambiente de trabajo colaborativo, ¡te invitamos a formar parte de EYNCOR ERP</p>
                ...
                <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
                    <div class="grid items-center md:grid-cols-2 md:gap-x-20 gap-y-10">
                        <div class="pl-16 pr-10 sm:pl-6 md:pl-0 xl:pr-0 md:order-2 hidden">
                            ...
                            <div class="overflow-hidden aspect-w-3 aspect-h-4">
                                <img class="object-cover rounded-lg w-full h-full" src={confianza_img2} alt="" />
                            </div>

                        </div>

                        <div class="md:order-1">
                            <h2 class="eyncor_titulo text-3xl font-bold leading-tight sm:text-4xl lg:text-4xl"> Trabajamos con Colaboración </h2>
                            <p class="mt-4 text-xl leading-relaxed text-gray-600">En EYNCOR, potenciamos la innovación y el crecimiento mediante un ambiente que fomenta la convergencia de ideas y la fusión de habilidades individuales. Aquí, el trabajo colaborativo no solo es una filosofía, sino la clave para alcanzar logros significativos y trascender fronteras empresariales.</p>
