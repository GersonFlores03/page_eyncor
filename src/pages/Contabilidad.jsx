...
import banner_contabilidad from "../assets/contabilidad/banner_contabilidad.webp"
import banners_contabilidad from "../assets/banners/banner_contable.webp"
    ...
    return (
        <section className='eyncor_productos  lg:mt-[103px]'>
                ...
                <Carousel.Item>
                    ...
                    lg:absolute lg:top-[60%] lg:left-0 lg:-translate-y-1/2 lg:text-left ñg:pl-[200px]">
                        <div className='flex flex-col gap-4'>
                            <strong className='text-2xl  lg:text-5xl'>GESTIONA TU CONTABILIDAD CON NUESTRO ERP </strong>
            ...
            <div className='eyncor_productos_estaciones mb-3'>
                ...
                lg:text-5xl
                '>
                    Explora los módulos de contabilidad ERP
                </h2>
                <h4 className='
                eyncor_subtitulo
                text-center
