...
import icon_grifos from "../assets/icons/icon_grifo.webp"
import icon_soporte from "../assets/icons/icon_soporte.webp"
import icon_camion from "../assets/icons/icon_camion.webp"
...
import grifo_banner from "../assets/grifo/grifo_banner2.jpg"
import grifo_2 from "../assets/grifo/grifo_2.jpg"
    ...
    return (
        <section className='eyncor_productos  lg:mt-[103px]'>
            ...
            <Carousel className='eyncor_erp_carrusel mb-7'>
                <Carousel.Item>
                    ...
                    lg:absolute lg:top-[60%] lg:left-0 lg:-translate-y-1/2 lg:text-left ñg:pl-[200px]">
                        <div className='flex flex-col gap-4'>
                            <strong className='text-2xl  lg:text-5xl'>ERP PARA GRIFOS Y ESTACIONES DE SERVICIOS</strong>
                ...
                <Carousel.Item>
                    <img
                        className="d-block w-full h-[300px] lg:h-[600px] object-cover"
                        src={grifo_banner}
                        alt="glp"
                    />
                    <Carousel.Caption className="carousel-caption-centered">
            ...
            <div className='eyncor_productos_estaciones mb-10'>
                ...
                lg:text-5xl
                '>
                    Explora los módulos de grifos ERP
                </h2>
                <h4 className='
                eyncor_subtitulo
                text-center
                ...
                <a href="https://drive.google.com/file/d/1zTVbb3unCZfMwcAUDtGY1EbUVKFrv2Qe/view" target="_blank" rel="noopener noreferrer">
            ...
            <div className='eyncor_productos_estaciones'>
                ...
                lg:text-5xl
                '>
                    Control integral para grifos y estaciones
                </h2>
                <h4 className='
                eyncor_subtitulo
                text-center
                ...
                mb-10
                '>
                    Descubre nuestro ERP especializado para Grifos y Estaciones de Servicio, brindando control integral de calidad.
                </h4>
            </div>
            ...
            <div className='grifo_modulo_general mb-11'>
                <div className='modulo_contometro p-3 w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    <section className='icono_contometro'>
                        <img src={icon_grifos} className='w-16' alt="icon_grifo" />
                    </section>

                    <section className='contometro_texto w-80'>
                        <h3 className='text-xl text-white font-bold mb-2'>
                            Control de Contometros
                        </h3>
                        <p className='text-white'>
                            Supervisión automática de contómetros y turnos. Control en tiempo real de tanques, varillajes, abastecimiento e inventario.
                        </p>
                    </section>
                </div>
                <div className='modulo_soporte p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    <section className='icono_soporte'>
                        <img src={icon_soporte} className='w-16' alt="icon_soporte" />
                    </section>
                    ...
                    <section className='soporte_texto w-80'>
                        ...
                        <p className='text-white'>
                            Recibe ayuda instantánea por teléfono y WhatsApp sin costos extra, incluyendo un número de telefono.
                        </p>
                    </section>
                </div>
                <div className='modulo_tanques p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    <section className='icono_tanques'>
                        <img src={icon_camion} className='w-16' alt="icon_camionn" />
                    </section>
                    ...
                    <section className='tanques_texto w-80'>
                        ...
                        <p className='text-white'>
                            Optimiza la gestión con órdenes de compra, transferencias entre tanques y análisis estadístico de rotación de productos.
                        </p>
                    </section>
                </div>
                <div className='modulo_actualizacion p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    ...
                    <section className='actualizacion_texto w-80'>
                        ...
                        <p className='text-white'>
                            Actualizaciones personalizadas y reportes especiales sin límites ni costos adicionales, entregados en tiempo récord.
                        </p>
                    </section>
                </div>
                <div className='modulo_gestion p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    ...
                    <section className='gestion_texto w-80'>
                        ...
                        <p className='text-white'>
                            Gestión ágil con líneas de crédito, estrategias de cobranza y comprobantes personalizados con EYNCOR.
                        </p>
                    </section>
                </div>
                <div className='modulo_contabilidad p-3  w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                    ...
                    <section className='contabilidad_texto w-80'>
                        ...
                        <p className='text-white'>
                            Módulo financiero de EYNCOR - Gestión de costos, kardex, asientos automáticos, exportación de planes y reportes en PDF y Excel.
                        </p>
                    </section>
                </div>
            </div>
