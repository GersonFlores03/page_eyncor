...
const HomeCertificados = () => {
    return (
        <section class="py-20 bg-white sm:py-16 lg:py-36">
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="max-w-2xl mx-auto text-center">
                    <h2 class="text-3xl font-extrabold leading-tight text-blue-500 sm:text-4xl lg:text-5xl">Certificado Digitales</h2>
                    <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600 ">Certificados para empresas, Personas y Profesionales </p>
                </div>
