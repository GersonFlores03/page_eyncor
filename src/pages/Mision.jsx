...
import banner_mision from "../assets/banners/banner_mision.webp"
import mision_img1 from "../assets/nosotros/mision_img1.webp"
import mision_img2 from "../assets/nosotros/mision_img2.webp"
import mision_img3 from "../assets/nosotros/mision_img3.webp"
                ...
                <Carousel.Item>
                    ...
                    lg:absolute lg:top-[60%] lg:left-0 lg:-translate-y-1/2 lg:text-left ñg:pl-[200px]">
                        <div className='flex flex-col gap-4'>
                            <strong className='text-2xl  lg:text-5xl'>Descubre la Misión que Impulsa a EYNCOR ERP</strong>
                    ...
                    <div class="grid items-center md:grid-cols-2 md:gap-x-20 gap-y-10">
                        <div class="pl-16 hidden pr-10 sm:pl-6 md:pl-0 xl:pr-0 md:order-2">
                            <div class="overflow-hidden aspect-w-3 aspect-h-4">
                                <img class="object-cover rounded-lg w-full h-full" src={mision_img1} alt="mision" />
                            </div>
                        </div>
                ...
                <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
                    <div class="grid items-center md:grid-cols-2 md:gap-x-20 gap-y-10">
                        <div class="pl-16 pr-10 sm:pl-6 md:pl-0 xl:pr-0 md:order-2 hidden">
                            <div class="overflow-hidden aspect-w-3 aspect-h-4">
                                <img class="object-cover w-full rounded-lg  h-full" src={mision_img2} alt="mision" />
                            </div>
                        </div>
                        <div class="md:order-1">
            ...
            <section class="py-10 sm:py-16 lg:py-24">
                <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
                    <div class="grid items-center md:grid-cols-2 md:gap-x-20 gap-y-10">
                        <div class="pl-16 pr-10 sm:pl-6 md:pl-0 xl:pr-0 md:order-2 hidden">
                            <div class="overflow-hidden aspect-w-3 aspect-h-4">
                                <img class="object-cover w-full rounded-lg  h-full" src={mision_img3} alt="mision" />
                            </div>
