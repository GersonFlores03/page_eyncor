...
import oxigeno from "../assets/grifo/oxigeno.webp"
    ...
    return (
        <section className='eyncor_productos  lg:mt-[103px]'>
                ...
                <Carousel.Item>
                    ...
                    lg:absolute lg:top-[60%] lg:left-0 lg:-translate-y-1/2 lg:text-left ñg:pl-[200px]">
                        <div className='flex flex-col gap-4'>
                            <strong className='text-2xl  lg:text-5xl'>ERP PARA PLANTA DE OXIGENO</strong>
            ...
            <div className='eyncor_productos_estaciones mb-3'>
                ...
                lg:text-5xl
                '>
                    Explora los Módulos de Plantas de Oxígeno
                </h2>
                <h4 className='
                eyncor_subtitulo
                text-center
            ...
            <div className='eyncor_productos_estaciones'>
                ...
                lg:text-5xl
                '>
                    Control integral para plantas de oxigeno
                </h2>
                <h4 className='
                eyncor_subtitulo
                text-center
                ...
                mb-10
                '>
                    Descubre nuestro ERP especializado para oxigeno, brinda control integral de calidad.
                </h4>
            </div>
