...
const RegisterForms = () => {
  ...
  const { error, registro, isAuthenticated } = useAuth()
  ...
  const onSubmit = async (value) => {
    await registro(value)
  }

  useEffect(() => {
    if (isAuthenticated) navigate("/certificados");
  }, [isAuthenticated]);
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
          <div class="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
            <div class="absolute inset-0">
              <img class="object-cover w-full h-full" src={Certificados} alt="" />
            </div>
          ...
          <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
            <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
              <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl">Inscríbete</h2>
              <p class="mt-2 text-base text-gray-600 mb-4"> ¿Ya tiene una cuenta?  <a href="/login" title="" class="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">Iniciar sesión</a></p>
              ...
              <div class="space-y-5">
                ...
                <div>
                  <button className='inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-md bg-gradient-to-r from-fuchsia-600 to-blue-600 focus:outline-none hover:opacity-80 focus:opacity-80 mb-1 '> Registrate </button>
                  <ul>
