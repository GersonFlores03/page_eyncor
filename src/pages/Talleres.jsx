...
import banners_transporte from "../assets/tienda/automotriz.webp"
...
const Talleres = () => {
    return (
        <section className='eyncor_productos  lg:mt-[103px]'>
            <Carousel className='eyncor_erp_carrusel mb-7'>
                ...
                lg:absolute lg:top-[60%] lg:left-0 lg:-translate-y-1/2 lg:text-left ñg:pl-[200px]">
                        <div className='flex flex-col gap-4'>
                            <strong className='text-2xl  lg:text-5xl'>ERP PARA TU TALLERE AUTOMOTRIZ</strong>
            ...
            lg:text-5xl
            '>
                    Explora los módulos de talleres ERP
                </h2>
                <h4 className='
            eyncor_subtitulo
            text-center
            ...
            <div className='grifo_modulo_general mb-11'>
                <div className='modulo_contometro w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                ...
                <div className='modulo_soporte w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                ...
                <div className='modulo_tanques w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                ...
                <div className='modulo_actualizacion w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                ...
                <div className='modulo_gestion w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
                ...
                <div className='modulo_contabilidad w-[360px] h-[190px]  lg:w-[490px] lg:h-[200px] rounded-lg cursor-pointer flex items-center justify-center gap-10'>
            ...
            <section class="py-10 m:py-16 lg:py-24">
                <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div class="max-w-2xl mx-auto text-center mb-6">
                        <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">OTROS SOLO VENDEN SOFTWARE
