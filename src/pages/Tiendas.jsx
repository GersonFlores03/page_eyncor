...
import banner_tienda from "../assets/tienda/banner_tienda.webp"
import banners_tienda from "../assets/banners/banner_tienda.webp"
    ...
    return (
        <section className='eyncor_productos  lg:mt-[103px]'>
                ...
                <Carousel.Item>
                    ...
                    lg:absolute lg:top-[60%] lg:left-0 lg:-translate-y-1/2 lg:text-left ñg:pl-[200px]">
                        <div className='flex flex-col gap-4'>
                            <strong className='text-2xl  lg:text-5xl'>ERP PARA IMPULSAR TU NEGOCIO COMERCIAL</strong>
            ...
            <div className='eyncor_productos_estaciones mb-3'>
                ...
                lg:text-5xl
                '>
                    Explora los Módulos de Tiendas ERP
                </h2>
                <h4 className='
                eyncor_subtitulo
                text-center
                ...
                <a href="https://www.eyncor.com/images/brochure/EYNCOR_ERP_EMPRESAS_DIVERSAS_BROCHURE.pdf" target="_blank" rel="noopener noreferrer">
            ...
            <div className='eyncor_productos_estaciones'>
                ...
                mb-10
                '>
                    Descubre nuestro ERP especializado para tiendas, brinda control integral de calidad.
                </h4>
            </div>
