...
import banner_transporte from "../assets/transporte/banner_tranporte.webp"
import banners_transporte from "../assets/banners/banner_transporte.webp"
    ...
    return (
        <section className='eyncor_productos  lg:mt-[103px]'>
                ...
                <Carousel.Item>
                    ...
                    lg:absolute lg:top-[60%] lg:left-0 lg:-translate-y-1/2 lg:text-left ñg:pl-[200px]">
                        <div className='flex flex-col gap-4'>
                            <strong className='text-2xl  lg:text-5xl'>OPTIMIZANDO LA LOGÍSTICA ERP TRANSPORTE</strong>
            ...
            <div className='eyncor_productos_estaciones mb-3'>
                ...
                lg:text-5xl
                '>
                    Explora los módulos de transporte ERP
                </h2>
                <h4 className='
                eyncor_subtitulo
                text-center
